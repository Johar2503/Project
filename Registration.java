...
class MyFrame 
	...
	{ 
		...
		tcourse.setFont(new Font("Arial", Font.PLAIN, 15)); 
		tcourse.setSize(190, 20); 
		tcourse.setLocation(200, 200); 
		c.add(tcourse); 

		batch = new JLabel("Batch"); 
		batch.setFont(new Font("Arial", Font.PLAIN, 20)); 
		batch.setSize(100, 20); 
		batch.setLocation(100, 250); 
		c.add(batch);
		
		 

		tbatch = new JTextField(); 
		tbatch.setFont(new Font("Arial", Font.PLAIN, 15)); 
		tbatch.setSize(190, 20); 
		tbatch.setLocation(200, 250); 
		c.add(tbatch); 

		mail = new JLabel("EMail"); 
		mail.setFont(new Font("Arial", Font.PLAIN, 20)); 
		mail.setSize(100, 20); 
		mail.setLocation(100, 300); 
		c.add(mail);
	...
	{ 
		if (e.getSource() == sub) { 
			if(tname.getText().isEmpty()|| tmno.getText().isEmpty()|| tcourse.getText().isEmpty()|| tbatch.getText().isEmpty()|| tmail.getText().isEmpty()|| tadd.getText().isEmpty())
				res.setText("Enter all the details.");
